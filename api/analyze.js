...
- summary: 조문을 처음 보는 사람도 전체 내용을 이해할 수 있도록 쉬운 말로 풀어 쓴 해설. 한두 문장으로 요약하지 말고, 조문에 담긴 ①②③ 등 각 항·호의 내용과 요건·대상·예외를 빠짐없이 짚어가며 전체적으로 설명하라. 조문이 여러 항으로 구성되어 있으면 그 항들의 관계(원칙과 예외, 절차 순서 등)까지 자연스러운 문단으로 풀어써라. 짧게 압축하려고 내용을 생략하지 말 것. '현행 법령 원문에서 가져온 조문입니다' 같은 문구는 금지
